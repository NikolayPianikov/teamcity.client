...
${nuget_cmd} install src/TeamCity/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/TeamCity.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/TeamCity.dll \
-recurse:'src/TeamCity/*.cs' \
-doc:bin/TeamCity.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/TeamCity.dll was created successfully"
fi
