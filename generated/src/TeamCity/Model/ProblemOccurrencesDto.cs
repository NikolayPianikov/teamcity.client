...
{
    /// <summary>
    /// ProblemOccurrencesDto
    /// </summary>
    [DataContract]
    public partial class ProblemOccurrencesDto :  IEquatable<ProblemOccurrencesDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProblemOccurrencesDto" /> class.
        /// </summary>
        /// <param name="count">count.</param>
        /// <param name="href">href.</param>
        /// <param name="nextHref">nextHref.</param>
        /// <param name="prevHref">prevHref.</param>
        /// <param name="problemOccurrence">problemOccurrence.</param>
        /// <param name="passed">passed.</param>
        /// <param name="failed">failed.</param>
        /// <param name="newFailed">newFailed.</param>
        /// <param name="ignored">ignored.</param>
        /// <param name="muted">muted.</param>
        public ProblemOccurrencesDto(int? count = default(int?), string href = default(string), string nextHref = default(string), string prevHref = default(string), List<ProblemOccurrenceDto> problemOccurrence = default(List<ProblemOccurrenceDto>), int? passed = default(int?), int? failed = default(int?), int? newFailed = default(int?), int? ignored = default(int?), int? muted = default(int?))
        {
            this.Count = count;
            this.Href = href;
        ...
        /// <summary>
        /// Gets or Sets ProblemOccurrence
        /// </summary>
        [DataMember(Name="problemOccurrence", EmitDefaultValue=false)]
        public List<ProblemOccurrenceDto> ProblemOccurrence { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProblemOccurrencesDto {\n");
            sb.Append("  Count: ").Append(Count).Append("\n");
            sb.Append("  Href: ").Append(Href).Append("\n");
            sb.Append("  NextHref: ").Append(NextHref).Append("\n");
            sb.Append("  PrevHref: ").Append(PrevHref).Append("\n");
            sb.Append("  ProblemOccurrence: ").Append(ProblemOccurrence).Append("\n");
        ...
        {
            return this.Equals(input as ProblemOccurrencesDto);
        }

        /// <summary>
        /// Returns true if ProblemOccurrencesDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ProblemOccurrencesDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProblemOccurrencesDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ProblemOccurrence == input.ProblemOccurrence ||
                    this.ProblemOccurrence != null &&
                    this.ProblemOccurrence.SequenceEqual(input.ProblemOccurrence)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProblemOccurrence != null)
                    hashCode = hashCode * 59 + this.ProblemOccurrence.GetHashCode();
                if (this.Passed != null)
