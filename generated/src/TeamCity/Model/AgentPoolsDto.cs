...
namespace TeamCity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgentPoolsDto :  IEquatable<AgentPoolsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentPoolsDto" /> class.
        /// </summary>
        ...
        public AgentPoolsDto(int? count = default(int?), string href = default(string), string nextHref = default(string), string prevHref = default(string), List<AgentPoolDto> agentPool = default(List<AgentPoolDto>))
        {
            this.Count = count;
            this.Href = href;
        ...
        public List<AgentPoolDto> AgentPool { get; set; }
        ...
        {
            return this.Equals(input as AgentPoolsDto);
        }

        /// <summary>
        /// Returns true if AgentPoolsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AgentPoolsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentPoolsDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.AgentPool != null &&
                    this.AgentPool.SequenceEqual(input.AgentPool)
                );
        }
