...
namespace TeamCity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CloudImagesDto :  IEquatable<CloudImagesDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudImagesDto" /> class.
        /// </summary>
        ...
        public CloudImagesDto(int? count = default(int?), string nextHref = default(string), string prevHref = default(string), string href = default(string), List<CloudImageDto> cloudImage = default(List<CloudImageDto>))
        {
            this.Count = count;
        ...
        public List<CloudImageDto> CloudImage { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloudImagesDto {\n");
        ...
        {
            return this.Equals(input as CloudImagesDto);
        }

        /// <summary>
        /// Returns true if CloudImagesDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CloudImagesDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloudImagesDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.CloudImage.SequenceEqual(input.CloudImage)
                );
        }
