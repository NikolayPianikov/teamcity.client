...
namespace TeamCity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ThrowableDto :  IEquatable<ThrowableDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThrowableDto" /> class.
        /// </summary>
        ...
        public ThrowableDto(ThrowableDto cause = default(ThrowableDto), List<StackTraceElementDto> stackTrace = default(List<StackTraceElementDto>), string message = default(string), List<ThrowableDto> suppressed = default(List<ThrowableDto>), string localizedMessage = default(string))
        {
            this.Cause = cause;
        ...
        {
            return this.Equals(input as ThrowableDto);
        }

        /// <summary>
        /// Returns true if ThrowableDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ThrowableDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThrowableDto input)
        {
            if (input == null)
                return false;
