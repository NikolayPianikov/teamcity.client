...
namespace TeamCity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MutesDto :  IEquatable<MutesDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MutesDto" /> class.
        /// </summary>
        ...
        public MutesDto(int? count = default(int?), string nextHref = default(string), string prevHref = default(string), string href = default(string), List<MuteDto> mute = default(List<MuteDto>))
        {
            this.Count = count;
        ...
        public List<MuteDto> Mute { get; set; }
        ...
        {
            return this.Equals(input as MutesDto);
        }

        /// <summary>
        /// Returns true if MutesDto instances are equal
        /// </summary>
        /// <param name="input">Instance of MutesDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MutesDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Mute != null &&
                    this.Mute.SequenceEqual(input.Mute)
                );
        }
