...
namespace TeamCity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VcsRootsDto :  IEquatable<VcsRootsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VcsRootsDto" /> class.
        /// </summary>
        ...
        public VcsRootsDto(int? count = default(int?), string href = default(string), string nextHref = default(string), string prevHref = default(string), List<VcsRootDto> vcsRoot = default(List<VcsRootDto>))
        {
            this.Count = count;
            this.Href = href;
        ...
        {
            return this.Equals(input as VcsRootsDto);
        }

        /// <summary>
        /// Returns true if VcsRootsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of VcsRootsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VcsRootsDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.VcsRoot != null &&
                    this.VcsRoot.SequenceEqual(input.VcsRoot)
                );
        }
