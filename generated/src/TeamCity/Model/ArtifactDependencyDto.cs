...
namespace TeamCity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArtifactDependencyDto :  IEquatable<ArtifactDependencyDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArtifactDependencyDto" /> class.
        /// </summary>
        ...
        public ArtifactDependencyDto(string id = default(string), string name = default(string), string type = default(string), bool? disabled = default(bool?), bool? inherited = default(bool?), string href = default(string), PropertiesDto properties = default(PropertiesDto), BuildTypeDto sourceBuildType = default(BuildTypeDto))
        {
            this.Id = id;
            this.Name = name;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArtifactDependencyDto {\n");
        ...
        {
            return this.Equals(input as ArtifactDependencyDto);
        }

        /// <summary>
        /// Returns true if ArtifactDependencyDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ArtifactDependencyDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArtifactDependencyDto input)
        {
            if (input == null)
                return false;
