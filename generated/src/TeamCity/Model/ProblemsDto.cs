...
namespace TeamCity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProblemsDto :  IEquatable<ProblemsDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProblemsDto" /> class.
        /// </summary>
        /// <param name="count">count.</param>
        /// <param name="nextHref">nextHref.</param>
        /// <param name="prevHref">prevHref.</param>
        /// <param name="problem">problem.</param>
        public ProblemsDto(int? count = default(int?), string nextHref = default(string), string prevHref = default(string), List<ProblemDto> problem = default(List<ProblemDto>))
        {
            this.Count = count;
        ...
        public List<ProblemDto> Problem { get; set; }
        ...
        {
            return this.Equals(input as ProblemsDto);
        }

        /// <summary>
        /// Returns true if ProblemsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ProblemsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProblemsDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Problem != null &&
                    this.Problem.SequenceEqual(input.Problem)
                );
        }
