...
namespace TeamCity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgentRequirementDto :  IEquatable<AgentRequirementDto>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgentRequirementDto {\n");
        ...
        {
            return this.Equals(input as AgentRequirementDto);
        }

        /// <summary>
        /// Returns true if AgentRequirementDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AgentRequirementDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentRequirementDto input)
        {
            if (input == null)
                return false;
