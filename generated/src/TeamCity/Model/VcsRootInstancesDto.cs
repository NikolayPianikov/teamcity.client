...
namespace TeamCity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VcsRootInstancesDto :  IEquatable<VcsRootInstancesDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VcsRootInstancesDto" /> class.
        /// </summary>
        ...
        public VcsRootInstancesDto(int? count = default(int?), string href = default(string), string nextHref = default(string), string prevHref = default(string), List<VcsRootInstanceDto> vcsRootInstance = default(List<VcsRootInstanceDto>))
        {
            this.Count = count;
            this.Href = href;
        ...
        /// </summary>
        [DataMember(Name="vcs-root-instance", EmitDefaultValue=false)]
        public List<VcsRootInstanceDto> VcsRootInstance { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VcsRootInstancesDto {\n");
        ...
        {
            return this.Equals(input as VcsRootInstancesDto);
        }

        /// <summary>
        /// Returns true if VcsRootInstancesDto instances are equal
        /// </summary>
        /// <param name="input">Instance of VcsRootInstancesDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VcsRootInstancesDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.VcsRootInstance.SequenceEqual(input.VcsRootInstance)
                );
        }
