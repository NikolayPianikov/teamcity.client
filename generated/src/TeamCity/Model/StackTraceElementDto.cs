...
namespace TeamCity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StackTraceElementDto :  IEquatable<StackTraceElementDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StackTraceElementDto" /> class.
        /// </summary>
        ...
        public StackTraceElementDto(string classLoaderName = default(string), string moduleName = default(string), string moduleVersion = default(string), string methodName = default(string), string fileName = default(string), int? lineNumber = default(int?), string className = default(string), bool? nativeMethod = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StackTraceElementDto {\n");
        ...
        {
            return this.Equals(input as StackTraceElementDto);
        }

        /// <summary>
        /// Returns true if StackTraceElementDto instances are equal
        /// </summary>
        /// <param name="input">Instance of StackTraceElementDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StackTraceElementDto input)
        {
            if (input == null)
                return false;
